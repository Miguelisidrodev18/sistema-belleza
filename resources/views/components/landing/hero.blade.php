...
<x-ui.section id="hero" :bg="$heroBgType === 'gradient' ? 'gradient' : 'dark'" padding="none" :animated="false">
    ...
    <div class="section-container relative z-10 flex min-h-screen flex-col items-center justify-center pt-20 text-center">
        ...
        <x-ui.heading :level="1" size="hero" color="white" align="center" class="text-balance">
            Tu pasión es tu profesión
        </x-ui.heading>

        <x-ui.text size="xl" color="white" class="mx-auto mt-6 max-w-2xl opacity-90">
            Formación profesional en belleza, estética y moda con docentes especializados y aprendizaje práctico desde el primer día.
        </x-ui.text>
